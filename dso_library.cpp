...
static float photometricgamma = 0.f;
...
//IOWrap::SampleOutputWrapper* wrapper;
...
bool sb_init_slam_system(SLAMBenchLibraryHelper * slam_settings) {
    ...
    K(0,0) =  grey_sensor->Intrinsics[0];
    K(1,1) =  grey_sensor->Intrinsics[1];
    K(0,2) =  grey_sensor->Intrinsics[2];
    K(1,2) =  grey_sensor->Intrinsics[3];
    dso::setGlobalCalib(grey_sensor->Width, grey_sensor->Height, K);
...
//
    viewer = new IOWrap::PangolinDSOViewer(grey_sensor->Width,grey_sensor->Height, true);
